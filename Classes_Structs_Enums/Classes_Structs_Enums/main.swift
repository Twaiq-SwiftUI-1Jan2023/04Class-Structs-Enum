...
// MARK: - Creating and sorting a List
    // Sorted by first name as declared in Comparable
var students: [Student] = [
    Student(firstName: "John", lastName: "Doe", age: 20, department: .English),
    Student(firstName: "Arnold", lastName: "Doe", age: 21, department: .Physics),
    Student(firstName: "william", lastName: "Smith", age: 24, department: .Math)
]

students.sort()

print("SORTING A LIST OF OBJECTS USING FIRST NAME:")
